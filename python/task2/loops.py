"""Module with loop iteration of list with some logic in it"""


def print_even_nums():
    """output even numbers from hardcoded list
    and stops after reaching number 237"""
    numbers = [
